C #!/bin/bash
# Inshackle vH.!
# recoded by: Hackology
# github.com/hackologyhq/inshackle-bot
...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded by Hackology (thanks to linuxchoice )\e[0m\n"
}
